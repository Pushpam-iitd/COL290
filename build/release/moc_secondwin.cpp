...
QT_MOC_LITERAL(10, 201, 24), // "on_pushButton_11_clicked"
QT_MOC_LITERAL(11, 226, 23), // "on_pushButton_9_clicked"
QT_MOC_LITERAL(12, 250, 24) // "on_pushButton_10_clicked"

    },
    "secondwin\0on_pushButton_clicked\0\0"
...
void secondwin::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        secondwin *_t = static_cast<secondwin *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject secondwin::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_secondwin.data,
      qt_meta_data_secondwin,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *secondwin::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_secondwin.stringdata0))
        return static_cast<void*>(const_cast< secondwin*>(this));
